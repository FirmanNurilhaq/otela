    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <?php else: ?>
            <?php foreach ($produk as $p): ?>
                <div class="kartu-produk relative bg-white border border-gray-200 rounded-lg p-4 shadow-sm transition-transform duration-300 hover:scale-105 hover:shadow-md overflow-hidden flex flex-col">
                    ...
                    <div class="bg-gray-50 p-3 rounded-md mt-auto">
