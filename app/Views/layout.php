...
=======
    ...
    $pesanDefault = "Halo Otela, saya " . $namaUser . ". Saya ingin bertanya tentang produk Anda.";
    $linkWhatsApp = "https://wa.me/6282144696226?text=" . urlencode($pesanDefault);
...
=======
        ...
        <a href="<?= $linkWhatsApp ?>" target="_blank" class="flex items-center text-teal-600 hover:text-teal-700 font-semibold">
>>>>>>> ff275ed (Updated Revisi Last)
